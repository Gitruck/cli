...
var require_commander = __commonJS({
  "node_modules/commander/index.js"(exports) {
    ...
    exports.program = new Command10();
    exports.createCommand = (name) => new Command10(name);
...
var require_index_umd = __commonJS({
  "node_modules/hash-wasm/dist/index.umd.js"(exports, module) {
    (function(global2, factory) {
      ...
      exports2.createBLAKE3 = createBLAKE32;
...
function migrateLegacyHome() {
  ...
  try {
    ...
    if (existsSync(join(GITRUCK_HOME, "config.json"))) return;
...
function resolveJianyingDraftDir(opt) {
  ...
  if (saved && existsSync4(saved)) return saved;
...
function currentVersion() {
  try {
    const { version: version2 } = JSON.parse(readFileSync3(join7(packageRoot(), "package.json"), "utf8"));
    return version2;
  } catch {
    return "0.0.0";
  }
...
async function runDoctor() {
  ...
  const colFile = col ? join8(columnsDir(), `${col}.json`) : void 0;
  rows.push({
    name: "\u5F53\u524D\u680F\u76EE",
    status: "ok",
...
async function runInit(opts) {
  ...
  if (!jianyingDraftDir) {
    ...
    if (manual) {
      if (existsSync8(manual)) jianyingDraftDir = resolve2(manual);
...
async function runInitNonInteractive(opts) {
  ...
  if (dirOpt && dirOpt !== "auto") jianyingDraftDir = resolve2(dirOpt);
...
async function load() {
  if (!existsSync9(CACHE_FILE)) return {};
  try {
...
async function loadSessions() {
  if (!existsSync9(SESSION_FILE)) return {};
  try {
...
async function extractAudio(inputAbs, ffmpegPath) {
  ...
  if (existsSync10(out)) return out;
...
function materialPathsFromGtrk(gtrk) {
  ...
  for (const m of gtrk.materials || []) {
    ...
    if (!existsSync11(m.path)) throw new Error(`gtrk \u7D20\u6750\u6587\u4EF6\u4E0D\u5B58\u5728\uFF1A${m.path}`);
...
async function runOralCut(input, opts) {
  ...
  if (!existsSync12(inputAbs)) throw new Error(`\u6BDB\u7247\u4E0D\u5B58\u5728\uFF1A${inputAbs}`);
  ...
  let scriptPath = opts.script ? resolve3(opts.script) : void 0;
  if (!scriptPath) {
  ...
  const script = scriptPath ? await readFile3(scriptPath, "utf8") : void 0;
  let draftDir;
  if (wantJianying) {
  ...
  log.step(
    `\u25B6 \u667A\u80FD\u53E3\u64AD\u526A\u8F91\uFF1A${basename5(inputAbs)}\uFF08\u9884\u8BBE ${opts.preset}${opts.visualAssist ? " \xB7 \u89C6\u89C9\u515C\u5E95(720p)" : ""}\uFF0C\u683C\u5F0F ${formats.join("/")}${opts.render ? " \xB7 \u672C\u5730\u6E32\u67D3" : ""}\uFF09`
  );
  ...
  log.info(
    opts.visualAssist ? `\u5DF2\u538B 720p \u4EE3\u7406\uFF08\u4E0A\u4F20\u7269\uFF09\uFF1A${basename5(artifact)}` : `\u5DF2\u62BD 16k \u5355\u58F0\u9053 mp3\uFF08\u4E0A\u4F20\u7269\uFF09\uFF1A${basename5(artifact)}`
  );
  log.step("\u2461 \u4E0A\u4F20\u62BD\u51FA\u7269\u5230\u4E91\u7AEF\u2026");
...
function registerRender(program3) {
  program3.command("render <gtrk>").description("\u672C\u5730\u6E32\u67D3\uFF1Agtrk \u5DE5\u7A0B\u6309 EDL \u7528\u672C\u5730 ffmpeg \u6E32\u67D3\u6210\u7247 mp4\uFF08\u7D20\u6750\u53D6\u539F\u7247\u672C\u5730\u8DEF\u5F84\uFF09").option("-o, --out <file>", "\u8F93\u51FA mp4 \u8DEF\u5F84\uFF08\u7F3A\u7701 = <gtrk \u540C\u76EE\u5F55>/<gtrk \u540D>.mp4\uFF09").option("--crf <n>", "\u89C6\u9891\u8D28\u91CF CRF 14-28\uFF08\u8D8A\u5C0F\u8D8A\u6E05\u6670/\u6587\u4EF6\u8D8A\u5927\uFF0C\u9ED8\u8BA4 18\uFF09").option("--codec <c>", "\u89C6\u9891\u7F16\u7801\uFF08\u9ED8\u8BA4 h264\uFF09").option("--ffmpeg-path <dir>", "\u6307\u5B9A ffmpeg/ffprobe \u6240\u5728\u76EE\u5F55\uFF08\u7F3A\u7701 ~/.gitruck/ffmpeg \u2192 \u7CFB\u7EDF\uFF09").option("--no-open", "\u5B8C\u6210\u540E\u4E0D\u81EA\u52A8\u6253\u5F00\u4EA7\u7269\u76EE\u5F55").option("--json", "\u673A\u8BFB\u6A21\u5F0F\uFF1A\u4EBA\u8BFB\u65E5\u5FD7\u8F6C stderr\uFF0Cstdout \u53EA\u8F93\u51FA\u7ED3\u679C JSON").action(async (gtrk, opts) => {
    ...
    if (!existsSync13(gtrkAbs)) throw new Error(`gtrk \u5DE5\u7A0B\u4E0D\u5B58\u5728\uFF1A${gtrkAbs}`);
    ...
    if (opts.open) openFolder(dirname3(outMp4));
    if (opts.json) {
...
function resolvePaths(opts) {
  const project = opts.project ? resolve6(opts.project) : void 0;
  let gtrkPath;
  if (opts.gtrk) {
  ...
  if (!existsSync14(gtrkPath)) throw new Error(`\u627E\u4E0D\u5230\u5DE5\u7A0B\u6587\u4EF6\uFF1A${gtrkPath}`);
  let transcriptPath;
  if (opts.transcript) transcriptPath = resolve6(opts.transcript);
  else if (project)
...
async function runView(baseDir, gtrkPath, transcriptPath, opts) {
  if (!transcriptPath || !existsSync14(transcriptPath)) throw new Error(TRANSCRIPT_MISSING);
...
async function runLand(splitdocPath, baseDir, gtrkPath, transcriptPath, opts) {
  if (!existsSync14(splitdocPath)) throw new Error(`\u627E\u4E0D\u5230\u62C6\u5206\u7A3F\uFF1A${splitdocPath}`);
  if (!transcriptPath || !existsSync14(transcriptPath)) throw new Error(TRANSCRIPT_MISSING);
  log.step("\u25B6 \u6821\u9A8C\u62C6\u5206\u7A3F\u5E76\u843D\u5730\u2026");
...
async function runPlanMode(cfg, tier, broll, overrides, columnId, opts) {
  ...
  if (!existsSync15(dispatchPath)) throw new Error(`\u627E\u4E0D\u5230\u6D3E\u5355\u6E05\u5355\uFF1A${dispatchPath}\uFF08\u5148\u8DD1 gtrk split <\u62C6\u5206\u7A3F> \u843D\u5730\u6D3E\u5355\uFF09`);
...
async function readMgQueue(dispatchPath) {
  if (!existsSync16(dispatchPath)) throw new Error(`\u627E\u4E0D\u5230\u6D3E\u5355\u6E05\u5355\uFF1A${dispatchPath}\uFF08\u5148\u8DD1 gtrk split \u843D\u5730\u6D3E\u5355\uFF09`);
...
async function runLint(args, opts) {
  ...
  if (lint.ok) log.ok(`lint \u901A\u8FC7\uFF08${basename10(file)}\uFF1Bopaque=${lint.opaque}\uFF09`);
